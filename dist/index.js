...
var Button = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsx("button", __assign({ ref: ref, type: type, className: buttonClasses, disabled: disabled }, rest, { children: children })));
});
...
var Textfield = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("div", { className: wrapperClasses, children: [label && (jsxRuntime.jsxs("label", { htmlFor: inputId, className: labelClasses, children: [label, required && jsxRuntime.jsx("span", { className: styles$4.required, children: "*" })] })), jsxRuntime.jsx("input", __assign({ ref: ref, id: inputId, className: inputClasses, disabled: disabled, required: required, "aria-invalid": !!error, "aria-describedby": error ? "".concat(inputId, "-error") : undefined }, rest)), (error || helperText) && (jsxRuntime.jsx("div", { id: "".concat(inputId, "-error"), className: helperTextClasses, children: error || helperText }))] }));
});
...
var Option = function (_a) {
    ...
    return (jsxRuntime.jsx("option", __assign({ className: optionClasses, onClick: onClick, role: "option", "aria-selected": isSelected }, rest, { children: children })));
};
...
var Select = React.forwardRef(function (_a, _ref) {
    ...
    var _e = React.useState(value || ''), internalValue = _e[0], setInternalValue = _e[1];
    ...
    var selectedLabel = selectedOption
        ...
        : 'Select an option';
    return (jsxRuntime.jsxs("div", { ref: selectRef, className: wrapperClasses, children: [label && (jsxRuntime.jsxs("label", { htmlFor: selectId, className: labelClasses, children: [label, required && jsxRuntime.jsx("span", { className: styles$3.required, children: "*" })] })), jsxRuntime.jsxs("div", { className: selectClasses, onClick: handleToggle, role: "combobox", "aria-expanded": isOpen, "aria-haspopup": "listbox", "aria-disabled": disabled, children: [jsxRuntime.jsx("div", { className: styles$3.selectedValue, children: selectedLabel }), jsxRuntime.jsx("span", { className: styles$3.arrow, children: "\u25BC" })] }), isOpen && (jsxRuntime.jsx("div", { className: styles$3.dropdown, role: "listbox", "aria-labelledby": selectId, children: jsxRuntime.jsx("div", { className: styles$3.optionsList, children: React.Children.map(children, function (child) {
                        ...
                        return child;
                    }) }) })), (error || helperText) && (jsxRuntime.jsx("div", { className: helperTextClasses, children: error || helperText }))] }));
});
...
var Checkbox = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("div", { className: wrapperClasses, children: [jsxRuntime.jsxs("div", { className: styles$2.checkboxContainer, children: [jsxRuntime.jsx("input", __assign({ ref: ref, id: checkboxId, type: "checkbox", className: styles$2.input, checked: checked, disabled: disabled, onChange: handleChange, "aria-invalid": !!error, "aria-describedby": error ? "".concat(checkboxId, "-error") : undefined, "data-indeterminate": indeterminate }, rest)), jsxRuntime.jsxs("span", { className: styles$2.checkmark, children: [indeterminate && !checked && (jsxRuntime.jsx("span", { className: styles$2.indeterminate })), checked && !indeterminate && (jsxRuntime.jsx("span", { className: styles$2.checkmarkIcon, children: "\u2713" }))] }), label && (jsxRuntime.jsx("label", { htmlFor: checkboxId, className: labelClasses, children: label }))] }), (error || helperText) && (jsxRuntime.jsx("div", { id: "".concat(checkboxId, "-error"), className: helperTextClasses, children: error || helperText }))] }));
});
...
var Switch = React.forwardRef(function (_a, ref) {
    ...
    return (jsxRuntime.jsxs("div", { className: wrapperClasses, children: [jsxRuntime.jsxs("div", { className: styles$1.switchContainer, children: [jsxRuntime.jsx("input", __assign({ ref: ref, id: switchId, type: "checkbox", className: styles$1.input, checked: checked, disabled: disabled, onChange: handleChange, "aria-invalid": !!error, "aria-describedby": error ? "".concat(switchId, "-error") : undefined }, rest)), jsxRuntime.jsx("span", { className: styles$1.track, children: jsxRuntime.jsx("span", { className: styles$1.thumb }) }), label && (jsxRuntime.jsx("label", { htmlFor: switchId, className: labelClasses, children: label }))] }), (error || helperText) && (jsxRuntime.jsx("div", { id: "".concat(switchId, "-error"), className: helperTextClasses, children: error || helperText }))] }));
});
...
var Modal = function (_a) {
    ...
    var trapFocus = React.useCallback(function (event) {
        if (!modalRef.current)
            return;
    ...
    var savePreviousActiveElement = React.useCallback(function () {
        previousActiveElement.current = document.activeElement;
    }, []);
    // Функция для восстановления фокуса
    var restoreFocus = React.useCallback(function () {
        if (previousActiveElement.current) {
            previousActiveElement.current.focus();
        }
    }, []);
    // Функция для установки фокуса на первый элемент модалки
    var focusFirstElement = React.useCallback(function () {
        var _a, _b;
        var focusableElements = getFocusableElements();
        if (focusableElements.length > 0) {
    ...
    if (!open)
        return null;
    return (jsxRuntime.jsx("div", { className: "".concat(styles.backdrop, " ").concat(backdropClassName), onClick: handleBackdropClick, role: "dialog", "aria-modal": "true", "aria-labelledby": ariaLabelledby, "aria-describedby": ariaDescribedby, children: jsxRuntime.jsx("div", { ref: modalRef, className: "".concat(styles.modal, " ").concat(className), children: children }) }));
};
...
var ModalHeader = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "".concat(styles.modalHeader, " ").concat(className), children: [jsxRuntime.jsx("div", { className: styles.modalTitle, id: "modal-title", children: children }), onClose && (jsxRuntime.jsx("button", { className: styles.closeButton, onClick: onClose, "aria-label": closeButtonLabel, autoFocus: false, children: "\u00D7" }))] }));
};
ModalHeader.displayName = 'ModalHeader';

var ModalContent = function (_a) {
    var children = _a.children, _b = _a.className, className = _b === void 0 ? '' : _b;
    return (jsxRuntime.jsx("div", { className: "".concat(styles.modalContent, " ").concat(className), children: children }));
};
ModalContent.displayName = 'ModalContent';

var ModalActions = function (_a) {
    var children = _a.children, _b = _a.className, className = _b === void 0 ? '' : _b;
    return (jsxRuntime.jsx("div", { className: "".concat(styles.modalActions, " ").concat(className), children: children }));
};
...
exports.buttonStyles = styles$5;
exports.checkboxStyles = styles$2;
exports.modalStyles = styles;
exports.selectStyles = styles$3;
exports.switchStyles = styles$1;
exports.textfieldStyles = styles$4;
